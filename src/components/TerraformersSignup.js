...
const TerraformersSignup = () => {
  ...
  return (
    <div>
      ...
      axios.post("http://localhost:8080/terraformersSignup",reqBody).then((res)=>{
          console.log("terraformers created success");
      }).catch((err)=>{
        console.log("terraformers created failure");
      })
...
export default TerraformersSignup